...
class UserService:
    ...
    def __init__(self, users_collection, contents_collection, bcrypt):
        ...
        self.contents_collection = contents_collection 
        self.bcrypt = bcrypt
    ...
    def register_user(self, email, password):
        ...
        # 2. Derive a unique username from the email
        try:
        ...
        # 4. Construct the user data document
        user_data = {
            "email": email,
            "username": username,  # <--- CRITICAL FIX: Added unique username
